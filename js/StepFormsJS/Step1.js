	...
	function InitializeTextInputEvents()
	{
		$('#TextBoxFirstName')[0].oninput = function(){
			FixTextInputCharacters(	$('#TextBoxFirstName'));
     	};
		
		$('#TextBoxLastName')[0].oninput = function(){
			FixTextInputCharacters(	$('#TextBoxLastName'));
		};
	
		$('#TextBoxFathersName')[0].oninput = function(){
			FixTextInputCharacters(	$('#TextBoxFathersName'));
		};
		
		$('#TextBoxMothersName')[0].oninput = function(){
			FixTextInputCharacters(	$('#TextBoxMothersName'));
		};
