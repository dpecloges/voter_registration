...
«Καρδιά» του έργου είναι η ταυτοποίηση με τον ΕΕΚ και  επιστέγασμα της αξιοπιστίας και της εγκυρότητας του εγχειρήματος είναι η διασφάλιση της ταυτοπροσωπίας. 

### Βασική παραδοχή : Οι εγγραφές στο μητρώο του φορέα θα γίνονται σε χρονικό διάστημα που θα αποφασίσειη ΑΕΔΕ. 

### Σημείωση: Δίνουμε προτεραιότητα στην προεγγραφή και πληρωμή της εγγραφής για όσους ψηφίζουν στην κάλπη και μόνο εάν συμφωνηθεί η ηλεκτρονική ψηφοφορία προχωράμε στην υλοποίηση των λειτουργιών που σχετίζονται με την ηλεκτρονική ψηφοφορία.
...
Προτείνεται ο ψηφοφόρους που επιθυμεί να ψηφίσει εξ αποστάσεως να πιστοποιείται πρώτα με φυσική παρουσία.
